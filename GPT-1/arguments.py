...
class ModelArguments:
    ...
    max_seq_len: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The maximum total input sequence length after tokenization. Sequences longer "
                "than this will be truncated, sequences shorter will be padded. The context window of GPT-1 is 512."
            )
        }
    )
...
class TrainingArguments:
    ...
    train_dir: Optional[str] = field(
        default="/home/zhoupeng/zh2nlp_expr/ZhGPT/GPT-1/train_log",
        metadata={
    ...
    log_dir: Optional[str] = field(
        default='/home/zhoupeng/zh2nlp_expr/ZhGPT/GPT-1/logs',
        metadata={
